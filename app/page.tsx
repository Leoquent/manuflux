...
export default function Home() {
  ...
  return (
    <main className="relative">
      ...
      <Portfolio />
      <Process />
      <Pricing onOpenQuiz={() => setIsQuizOpen(true)} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="absolute bottom-8 left-8 z-20">
                <p className="text-2xl font-bold">Leo & Marvin</p>
            ...
            <div>
              ...
              >
                <p>
                  manuflux Studio wurde von Leo und Marvin gegründet, um die Lücke zwischen traditionellem Handwerk und moderner Technologie zu schließen. Wir verstehen beide Welten: Leo bringt die Expertise aus Design, Werbung und Kommunikation ein, während Marvin das Fundament aus IT, Software-Entwicklung und Technik liefert.
                </p>
                <p>
                  Diese Verbindung ermöglicht uns Lösungen, die nicht nur technisch exzellent sind, sondern auch intuitiv zu bedienen und visuell überzeugend. Wir arbeiten direkt mit Ihnen zusammen – ohne Agentur-Umwege, dafür mit voller Leidenschaft für das perfekte Ergebnis, das Ihren Betrieb messbar entlastet.
                </p>
      ...
      <WhyChooseUs />
      <FAQ onOpenChat={() => setIsChatbotOpen(true)} />
